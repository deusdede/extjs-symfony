...
use dsj\EstoqueBundle\Entity\Categoria;
use dsj\EstoqueBundle\Form\CategoriaType;
...
class CategoriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('dsjEstoqueBundle:Categoria')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('dsjEstoqueBundle:Categoria')->find($id);
     ...
     * @Method("post")
     * @Template("dsjEstoqueBundle:Categoria:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("dsjEstoqueBundle:Categoria:edit.html.twig")
     */
