...
/* dsjContatoBundle:Contact:index.html.twig */
class __TwigTemplate_c6f73b379434548c19db65b0be5a122e extends Twig_Template
{
...
<table class=\"records_list\">
    ...
    ";
        ...
        foreach ($context['_seq'] as $context['_key'] => $context['entity']) {
            ...
            <td><a href=\"";
            // line 16
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("contact_show", array("id" => $this->getAttribute($this->getContext($context, 'entity'), "id", array(), "any", false))), "html");
            echo "\">";
...
<ul>
    <li>
        <a href=\"";
        // line 37
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("contact_new"), "html");
        echo "\">
            Create a new entry
        </a>
    </li>
...
";
    ...
    {
        return "dsjContatoBundle:Contact:index.html.twig";
    }
