...
/* dsjEstoqueBundle:Categoria:edit.html.twig */
class __TwigTemplate_e8ff568b3c801ff71f051730e86207d1 extends Twig_Template
{
...
<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("categoria_update", array("id" => $this->getAttribute($this->getContext($context, 'entity'), "id", array(), "any", false))), "html");
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "dsjEstoqueBundle:Categoria:edit.html.twig";
    }
