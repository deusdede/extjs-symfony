...
/* dsjContatoBundle:Contact:edit.html.twig */
class __TwigTemplate_a38d69875cf40d7f85facd1c240fbfd6 extends Twig_Template
{
...
<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("contact_update", array("id" => $this->getAttribute($this->getContext($context, 'entity'), "id", array(), "any", false))), "html");
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "dsjContatoBundle:Contact:edit.html.twig";
    }
